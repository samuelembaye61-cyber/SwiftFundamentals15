...
var isEpmty: Bool = committedChallenges.isEmpty
if(isEpmty){committedChallenges.append("Commit to a challenge!")
}else if(committedChallenges.count == 1){print("The challenge you have chosen is \(committedChallenges[0])")
