...
var user = User(name: "samuel ", age: 25, height: 180.0, weight: 75.0, activityLevel: 7)
print("User \(user.name) is \(user.age) years old, \(user.height) cm tall, weighs \(user.weight) kg, and has an activity level of \(user.activityLevel).")
